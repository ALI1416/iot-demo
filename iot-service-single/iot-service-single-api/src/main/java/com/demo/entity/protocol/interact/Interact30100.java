...
@Protocol(code = 30100, name = "设置温度计配置", type = ProtocolType.INTERACT, deviceType = DeviceType.THERMOMETER, request = Interact30100.Request.class)
public class Interact30100 {
    ...
    public static class Request extends ToStringBase implements com.demo.entity.protocol.Protocol.Data {
        ...
        @Field(name = "刷新间隔", unit = FieldUnitEnum.SECOND)
        private Integer intervalRefresh;
        /**
         * 推送间隔(s 秒)
         */
        @Schema(description = "推送间隔(s 秒)")
        @Field(name = "推送间隔", unit = FieldUnitEnum.SECOND)
        private Integer intervalPush;
        /**
         * 温度上限(℃ 摄氏度)
         */
        @Schema(description = "温度上限(℃ 摄氏度)")
        @Field(name = "温度上限", unit = FieldUnitEnum.TEMPERATURE)
        private Integer temperatureMax;
        /**
         * 温度下限(℃ 摄氏度)
         */
        @Schema(description = "温度下限(℃ 摄氏度)")
        @Field(name = "温度下限", unit = FieldUnitEnum.TEMPERATURE)
